-- Existing canonical Smart Note pipeline fix discovered during live Ledger proof.
-- Supabase pgcrypto is installed under extensions; use the canonical PostgreSQL UUID generator
-- instead of the non-existent crypto.random_uuid() reference.
...
begin
 ...
 if p_human_note is null or p_naya_note is null or p_machine_note is null or p_intelligent_feed is null or p_intelligent_block is null or p_evidence is null or p_hub_state is null then raise exception 'SMART_NOTE_PIPELINE_PAYLOAD_INCOMPLETE'; end if;
