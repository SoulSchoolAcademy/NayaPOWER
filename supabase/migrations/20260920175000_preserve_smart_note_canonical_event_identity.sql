-- Preserve the canonical Smart Note event identity end-to-end.
-- v7_create_smart_note uses smart_note_events.id as the canonical event UUID.
-- The cognition projection must expose that same UUID as event_id and metadata.event_id.
