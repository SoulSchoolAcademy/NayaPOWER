-- Repair the canonical Smart Note receiver UUID fallback.
-- Production exposes gen_random_uuid(); the prior receiver function referenced
-- a nonexistent crypto schema when no canonical UUID was supplied.
