...
function install(){css();const bind=()=>{wireSidebar();window.__nayaOpenSurface=open};bind();setTimeout(bind,0);if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',bind,{once:true});
