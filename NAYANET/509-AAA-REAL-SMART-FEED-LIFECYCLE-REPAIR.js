...
const perspectiveNames=['HUMAN','CHILD','GRANDMA','NAYA','MACHINE','LEARNING','ULTIMATE MEANING',"WHAT'S IN IT FOR YOU?"];
...
.naya509-mission b{font-size:40px!important;line-height:1.15!important;font-weight:850!important}
.naya509-mission span{font-size:20px!important;line-height:1.4!important;font-weight:600!important}
.mission,.features{display:none!important}
@media(max-width:760px){.naya509-perspectives{grid-template-columns:1fr;gap:14px;margin:18px 0 22px}.naya509-perspective{padding:21px 20px!important}.naya509-perspective .layerHead b{font-size:19px!important}.naya509-perspective .layerBody{font-size:19px!important;line-height:1.56!important}.naya509-perspective.naya509-for-you{padding:24px 20px!important}.naya509-perspective.naya509-for-you .layerHead b{font-size:22px!important}.naya509-perspective.naya509-for-you .layerBody{font-size:20px!important}.naya509-mission b{font-size:29px!important}.naya509-mission span{font-size:18px!important}}
`;document.head.appendChild(s)}
function textOf(e){return(e.querySelector('.layerHead b')?.textContent||'').trim().replace(/\s+/g,' ').toUpperCase()}
function perspectiveKey(e){const t=textOf(e);if(t==='HUMAN')return'HUMAN';if(t==='CHILD')return'CHILD';if(t==='GRANDMA')return'GRANDMA';if(t==='NAYA')return'NAYA';if(t==='MACHINE')return'MACHINE';if(/^LEARNING|ADAPTIVE LEARNING/.test(t))return'LEARNING';if(/^ULTIMATE MEANING|WHAT IT MEANS/.test(t))return'ULTIMATE MEANING';if(/^WHAT'S IN IT FOR YOU|WHATS IN IT FOR YOU|WHAT IS IN IT FOR YOU/.test(t))return"WHAT'S IN IT FOR YOU?";return null}
