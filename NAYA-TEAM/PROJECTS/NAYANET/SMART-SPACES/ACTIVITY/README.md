# Smart Spaces — Activity Feed

Area-scoped working and handoff feed for Smart Spaces.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Smart Spaces Activity
