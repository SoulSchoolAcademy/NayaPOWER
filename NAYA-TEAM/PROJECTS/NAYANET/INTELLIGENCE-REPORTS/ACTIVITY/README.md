# Intelligence Reports — Activity Feed

Area-scoped working and handoff feed for Intelligence Reports.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Intelligence Reports Activity
