# Smart Mail — Activity Feed

Area-scoped working and handoff feed for Smart Mail.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Smart Mail Activity
