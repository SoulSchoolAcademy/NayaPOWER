# Intelligence Library — Activity Feed

Area-scoped working and handoff feed for Intelligence Library.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Intelligence Library Activity
