# Intelligent Hub — Activity Feed

**PURPOSE:** Area-scoped activity and handoff feed for the Intelligent Hub project.
...
## Relationship
NayaPOWER canonical event → Main Activity → NayaNET project Activity → Intelligent Hub Activity
