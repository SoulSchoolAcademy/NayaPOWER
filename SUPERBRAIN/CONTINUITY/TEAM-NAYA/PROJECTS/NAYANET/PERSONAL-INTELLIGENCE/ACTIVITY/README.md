# Personal Intelligence — Activity Feed

Area-scoped working and handoff feed for Personal Intelligence.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Personal Intelligence Activity
