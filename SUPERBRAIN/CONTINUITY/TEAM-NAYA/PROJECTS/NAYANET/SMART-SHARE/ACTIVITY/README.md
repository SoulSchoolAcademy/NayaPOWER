# Smart Share — Activity Feed

Area-scoped working and handoff feed for Smart Share.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Smart Share Activity
