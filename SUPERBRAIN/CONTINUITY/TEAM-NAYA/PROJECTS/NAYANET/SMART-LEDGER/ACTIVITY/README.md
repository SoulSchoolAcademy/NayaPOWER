# Smart Ledger — Activity Feed

Area-scoped working and handoff feed for Smart Ledger.
...
**Flow:** NayaPOWER canonical event → Main Activity → NayaNET Project Activity → Smart Ledger Activity
