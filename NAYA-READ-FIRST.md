# NAYA POWER — READ FIRST

**STATUS:** CANONICAL BOOT POINTER / MANDATORY
**PURPOSE:** Make the Naya Power operating sequence discoverable before substantive work begins.

## STOP BEFORE SUBSTANTIVE WORK

Do not execute a substantive Naya Power mission from conversation memory alone.

First enter the Naya Power execution chain:
...
Never claim a document was read, a state was verified, a deployment was checked, or an outcome was achieved unless the evidence was actually observed.
