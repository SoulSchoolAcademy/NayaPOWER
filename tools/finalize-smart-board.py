...
# Preserve the original V10 faceted jewel artwork + V10 board normalizer as the single Smart Board authority.
...
css=m.group(2)
repls={
    'gap:26px!important':'gap:28px!important',
    ...
    '.elite-board .layerBody{padding:27px 31px 33px!important;font-size:clamp(22px,1.9vw,30px)!important;':'.elite-board .layerBody{padding:27px 31px 33px!important;font-size:14px!important;',
    '.elite-board .dot{width:64px!important;height:64px!important;flex-basis:64px!important}':'.elite-board .dot{width:68px!important;height:68px!important;flex-basis:68px!important}',
    '.elite-board .dot .v10-icon{width:46px!important;height:46px!important}':'.elite-board .dot .v10-icon{width:50px!important;height:50px!important}',
...
for marker in ('What is Naya Power','LEARNING LESSON',"WHAT'S IN IT FOR YOU",'HOW TO APPLY / HOW TO USE','font-size:18px!important','font-size:14px!important','core','facet','shade','edge'):
