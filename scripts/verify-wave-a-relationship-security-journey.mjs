...
const ledger=await req(base+'/rest/v1/nayanet_smart_ledger?select=ledger_event_id,source_table,source_id&source_table=eq.nayanet_execution_receipts&source_id=eq.'+encodeURIComponent(first.execution_receipt_id),{headers:h(A.access_token)});
