...
# redesign simply to satisfy a nine-board count.
...
# Retired sidebar labels are forbidden; words such as Collective/Evidence may
# still legitimately occur inside the intelligent board/feed semantics.
for label in ['Smart Start','Smart Ledgers','Peer Connections','Collective Intelligence','Smart Mail — New','Evidence']:
