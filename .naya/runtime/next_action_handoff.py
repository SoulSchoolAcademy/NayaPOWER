...
def execute_cycle():
    ...
    receipt={
      ...
      "new_next_action":{"action":after["next_action"]["action"],"owner":"Naya","source_of_truth":".naya/control-plane/BLOCKS.json","handoff":after["handoff"],"success_condition":after["success_condition"]},
