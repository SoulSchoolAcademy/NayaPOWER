...
def main() -> int:
    required = [
        ...
        LIVE_HOST, LIVE_HOST_TEST, ADAPTER_CONTRACT, HOST_PROTOCOL,
    ]
    ...
    receipt = {
        ...
        "next_execution": "Use the live ChatGPT host bridge on a real task, evaluate candidates through the kernel, execute only SELECT, independently verify the external result, emit the receipt, and continue.",
    }
