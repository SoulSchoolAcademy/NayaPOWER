...
def stale_memory(principal_id=None,scope=None,project=None,principal_project=None,grants=()):
    out=[]
    for item in retrieve_canonical_ibs('', limit=10000, root=ROOT, principal_id=principal_id, scope=scope, project=project, principal_project=principal_project, grants=grants):
