...
def _identity_key(intent: str, actor_id: str, session_id: str, mission: str, message: str, next_action: str, recipients: list[str], evidence: list[str]) -> str:
    payload = [intent, actor_id, session_id, mission, message, next_action, recipients, evidence]
...
def emit_team_activity(
    *,
    ...
    identity_key = _identity_key(intent, actor_id, session_id, mission, message, next_action, recipient_list, evidence_list)
