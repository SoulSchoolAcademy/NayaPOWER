...
def main():
    ...
    legacy_projection_current=lg.get('current',{})
    legacy_projection_stale=(legacy_projection_current.get('active_block')!=active.get('id') or legacy_projection_current.get('next_action')!=state_next or legacy_projection_current.get('next_action_count')!=1)
