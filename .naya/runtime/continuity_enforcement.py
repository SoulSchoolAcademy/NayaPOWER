...
# Canonical historical event identities may contain uppercase letters or omit the
# time component; identity is preserved rather than rewritten merely to satisfy
# the validator. New event producers may use the stricter timestamped form.
